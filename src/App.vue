...
<div class="w-full flex items-center p-2 space-x-4" title="Network Details">
  ...
  <div v-if="networkinfo" :title="'Protocol version : '+networkinfo.protocolversion">
    <span class="flex items-center space-x-1 text-xs dark:text-gray-400 text-white">
        {{networkinfo.connections}} Connection
    </span>
    <span class="flex items-center space-x-1 text-xs dark:text-gray-400 text-gray-400">
